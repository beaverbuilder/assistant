...
export const Icon = ( { name } ) => {
	...
	case 'document':
		return (
			<svg width="99px" height="130px" viewBox="0 0 99 130" version="1.1" xmlns="http://www.w3.org/2000/svg">
				<g stroke="none" strokeWidth="4" fill="none" fillRule="evenodd" transform="translate(-66.000000, -265.000000)">
					<path d="M84,267 C75.163444,267 68,274.163444 68,283 L68,377 C68,385.836556 75.163444,393 84,393 L147,393 C155.836556,393 163,385.836556 163,377 L163,304.046927 C163,302.462911 162.373616,300.943162 161.257479,299.819176 L130.42734,268.772249 C129.300937,267.637926 127.768446,267 126.169861,267 L84,267 Z" stroke="currentColor" strokeWidth="4" fill="none"></path>
					<path d="M128,267 L163,302 L137,302 C132.029437,302 128,297.970563 128,293 L128,267 Z" fill="currentColor" stroke="none"></path>
				</g>
			</svg>
		)
	default:
