...
$xml_data .= '<rss version="2.0"
	...
	$xml_data .= '<pubDate>'.$data['post']->post_date.'</pubDate>
			<dc:creator><![CDATA['.get_the_author_meta( 'display_name', $data['post']->post_author ).']]></dc:creator>
        	<guid isPermaLink="false">'.$data['post']->guid.'</guid>
        	<description></description>
        	<content:encoded><![CDATA[ '.$data['post']->post_content.']]></content:encoded>
        	<excerpt:encoded><![CDATA[ '.$data['post']->post_excerpt.']]></excerpt:encoded>
        	<wp:post_id> '.$data['post']->ID.'</wp:post_id>
        	<wp:post_date><![CDATA['.$data['post']->post_date.']]></wp:post_date>
        	<wp:post_date_gmt><![CDATA['.$data['post']->post_date_gmt.']]></wp:post_date_gmt>
        	<wp:comment_status><![CDATA['.$data['post']->comment_status.']]></wp:comment_status>
        	<wp:ping_status><![CDATA['.$data['post']->ping_status.']]></wp:ping_status>
        	<wp:post_name><![CDATA['.$data['post']->post_title.']]></wp:post_name>
        	<wp:status><![CDATA['.$data['post']->post_status.']]></wp:status>
        	<wp:post_parent> '.$data['post']->post_parent.'</wp:post_parent>
			<wp:menu_order> '.$data['post']->menu_order.'</wp:menu_order>
			<wp:post_type><![CDATA['.$data['post']->post_type.']]></wp:post_type>
